...
[Game Link](https://kevinnatera.github.io/JRPG/)
...
For MVP, the player will preload into a battle with one playable character on their team. When it is the turn of the player's character, they will be able to see the menu buttons and select one action for the character to perform (such as attacking the enemy or healing) , the character will perform it, then their turn will end. When it is an enemy's turn, the enemy will attack the character on the player team at random, then their turn will end. When all the enemies have been defeated (their remaining health, likely displayed above their heads, reaches 0 ), the player wins the battle and obtains rewards to further develop their characters. If the character on the player's team is defeated, the player loses the game and has to start all over from the beginning. 
...
Players will be able to:
    ...
    - choose and execute commands to defeat a powerful enemy
    - resolve tough situations generated by pure misfortune
